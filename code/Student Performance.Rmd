...
3) Build a predictive model: Goal - A)what factors are important in student performanc & B) What techniques can we use to build a good predictive model
...
=>use regression techniques and finde adequate specificaiton (model comparison)
